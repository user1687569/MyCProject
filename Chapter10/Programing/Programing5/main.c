...
void analyze_hand(int handCard[][2])
{
    ...
    /* check for A Card*/
    ACard = handCard[NUM_CARDS-1][0] == 12 ? true : false;
...
void print_result()
{
    if(straight && flush && ACard)
        printf("A Card Straight flush");
    else if(smallStraight && flush && ACard)
        printf("Small A Card Straight flush");
